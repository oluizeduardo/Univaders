...
public class Framework extends Canvas {
    ...
    public Framework ()
    {
        ...
        // Esse trecho precisa estar dentro de um Thread para funcionar as configurações de UI.
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Atire nos Aliens e defenda a UNIVÁS", x, (int) (y*1.20));                  
                g2d.drawString("Pressione R para reiniciar o jogo", x, (int) (y*1.30));
                g2d.drawString("Pressione ESC em qualquer momento para sair", x, (int) (y*1.40)); 
                g2d.drawString("Clique para iniciar o jogo. . .", x, (int) (y*1.50)); 
